...
/**
 * 
 * This is a stand alone program that you can just run as is.
 * It requires JAVA 8 and it has no dependencies.
 * 
**/
public class DemoN4J {
    public static void main(String args[]) {
        System.out.println("Demo N4J");
        
        //
        // below is the code copied from
        // https://lorenzoongithub.github.io/nudge4j/
        // 
        // The latest code snippet is always available here: 
        // https://lorenzoongithub.github.io/nudge4j/dist/n4j.snippet.java
        // 
        // Always that check you are running the latest code by visiting the project  
